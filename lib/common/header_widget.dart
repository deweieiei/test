    ...
    return Container(
      child: Stack(
        children: [
          ...
          ClipPath(
            child: Container(
              margin: EdgeInsets.fromLTRB(150, 60, 20, 30),
              child: Column(
                children: [
                  Image.asset(
...
class HeaderRegister extends StatefulWidget {
  ...
  const HeaderRegister(this._height, this._showIcon, this._icon, {Key? key})
      : super(key: key);

  @override
  State<HeaderRegister> createState() =>
      _HeaderRegisterState(_height, _showIcon, _icon);
}
...
class _HeaderRegisterState extends State<HeaderRegister> {
  ...
  _HeaderRegisterState(this._height, this._showIcon, this._icon);
